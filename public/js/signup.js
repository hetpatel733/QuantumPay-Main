...
if (urlParams.has('error')) {
    ...
    if (errorMessage === 'Wrongloginemail') {
        issueheard("Please Register here before Login");
    } else if (errorMessage === 'SignUnameused') {
        issueheard('Username is already used');
    } else if (errorMessage === 'SignPassPatt') {
        issueheard('Please match the following password pattern for Safety');
    } else if (errorMessage === 'SignPassEequal') {
        issueheard("Your Password and Confirm Password Doesn't match");
    }
    else{}
}
