...
const CoinselectFunction = async (req, res, app) => {
    ...
    // Check if there's already a pending payment with this order_id
    let paymentdetails = await paymentlogschema.findOne({ order_id, status: "pending" });
